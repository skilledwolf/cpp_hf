"""Companion to quartermetal_D_scan.py: same n, D, ε, but sameU reference.

The eps=5 + u0 D-scan shows PM winning by ~25 meV everywhere.  Re-run with
sameU reference (non-int CN at the same external D) to test whether reference
